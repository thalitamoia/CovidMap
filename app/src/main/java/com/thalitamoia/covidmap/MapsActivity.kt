package com.thalitamoia.covidmap
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.setMinZoomPreference(2.9f)
    ...
    private fun readItems(array: JSONArray, jsonCounty:List<Triple<Double,Double,String>>): ArrayList<LatLng> {
